...
# daemon.py now lives at src/inkdown/daemon.py (was inkdown_daemon.py)
DAEMON_SCRIPT = os.path.join(_HERE, 'daemon.py')
# Fallback: legacy flat layout
if not os.path.exists(DAEMON_SCRIPT):
    DAEMON_SCRIPT = os.path.join(os.path.dirname(os.path.dirname(_HERE)), 'inkdown_daemon.py')
