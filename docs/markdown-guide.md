...
> Reference for the Markdown syntax supported by Inkdown (rendered via `marked.js` → `DOMPurify` → `highlight.js` / KaTeX / Mermaid). Moved from `structure.md` (was misnamed).
